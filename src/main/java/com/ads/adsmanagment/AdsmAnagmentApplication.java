...
public class AdsmAnagmentApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Dentist dentist = new Dentist(null, "Dr. John", "Doe", "43424234242","jhone@gmail.com", null);
        dentistService.addDentist(dentist);

        System.out.println("Creating new  Patient ");
        Patient patient = new Patient(null, "hanan", "carlos", "34245656","han@gmail.com",  LocalDateTime.now(), new Address("4 th", "london", "uk"), null);
